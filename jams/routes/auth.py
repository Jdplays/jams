...
import random
import string
from flask import Blueprint, abort, current_app, flash, redirect, session, url_for, render_template, request, url_for
...
from jams.models import db, User, UserConfig
